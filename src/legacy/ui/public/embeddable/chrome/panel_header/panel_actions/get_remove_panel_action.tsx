...
import { Container, ContextMenuAction, Embeddable, ViewMode } from 'ui/embeddable';
...
export function getRemovePanelAction(onDeletePanel: () => void) {
  return new ContextMenuAction<
    Embeddable<any, any>,
    Container<any, { view: { viewMode: ViewMode } }, any>
  >(
    {
    ...
    },
    {
      ...
      isVisible: ({ container }) => container.getOutput().view.viewMode === ViewMode.EDIT, // &&
