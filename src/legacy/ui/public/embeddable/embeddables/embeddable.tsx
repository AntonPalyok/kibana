...
import { ContainerOutput } from '../containers';
...
export abstract class Embeddable<I = { viewMode: ViewMode }, O = {}> {
   ...
   */
  public renderWithChrome(domNode: HTMLElement | ReactNode) {
    // @ts-ignore
    ReactDOM.render(domNode, <EmbeddableChrome embeddable={this} />);
  }
