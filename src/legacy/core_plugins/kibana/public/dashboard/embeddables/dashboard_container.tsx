...
import { Filter, Query, RefreshConfig, ViewMode } from 'ui/embeddable/types';
...
export interface DashboardContainerState extends DashboardState {
  hidePanelTitles: boolean;
  viewMode: ViewMode;
}
...
> {
  constructor(
    ...
    super(
      { type: DASHBOARD_CONTAINER_TYPE, id },
      {
        ...initialInput,
        viewMode: initialInput.view.viewMode,
        hidePanelTitles: initialInput.view.hidePanelTitles,
      },
      initialInput
    );
  }
  ...
  public onInputChanged(input: DashboardState) {
    ...
    if (changed) {
      this.emitOutputChanged({
        ...input,
        viewMode: input.view.viewMode,
        hidePanelTitles: input.view.hidePanelTitles,
      });
    }
  }
