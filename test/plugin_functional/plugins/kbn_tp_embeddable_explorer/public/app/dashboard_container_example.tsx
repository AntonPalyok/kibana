...
} from 'plugins/kibana/dashboard/embeddables';
import React from 'react';
import { EmbeddableFactory } from 'ui/embeddable';
import { dashboardInput } from './dashboard';

export interface DashboardContainerExampleProps {
  getEmbeddableFactory: <I, O>(type: string) => EmbeddableFactory<I, O> | undefined;
}

export class DashboardContainerExample extends React.Component<DashboardContainerExampleProps, { viewMode: string}> {
  ...
  public switchViewMode = () => {
    ...
    if (!this.dashboardContainer) { return ; }
      ...
      newState.view.viewMode = newMode;
  ...
  public render() {
    return (
      <div className="app-container dshAppContainer">
        ...
        <EuiButton onClick={this.switchViewMode}>{this.state.viewMode === 'view' ? 'Edit' : 'View'}</EuiButton>
